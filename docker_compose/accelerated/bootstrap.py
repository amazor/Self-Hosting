#!/usr/bin/env python3
"""Accelerated VM bootstrap — see stack_config.py for steps.

Usage:
  cd docker_compose/accelerated && python3 bootstrap.py
  cd docker_compose/accelerated && python3 bootstrap.py --up
  cd docker_compose/accelerated && python3 bootstrap.py --force -v
"""
...
from docker_compose.accelerated import stack_config
