#!/usr/bin/env python3
"""Monitoring VM bootstrap — see stack_config.py for steps.

Usage:
  cd docker_compose/monitoring && python3 bootstrap.py
  cd docker_compose/monitoring && python3 bootstrap.py --up
  cd docker_compose/monitoring && python3 bootstrap.py --force -v
"""
...
from docker_compose.monitoring import stack_config
