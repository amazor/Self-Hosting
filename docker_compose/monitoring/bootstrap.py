...
def validate_guardrails(env: dict[str, str]) -> None:
    ...
    checks = {
        "GRAFANA_ADMIN_PASSWORD": (
            "Set a strong password in .env, or run bootstrap with --force to accept the default (e.g. local testing only)."
        ),
    }
...
// Discovers Docker containers and ships their logs to Loki.
